...
class CarouselMedia {
  ...
  factory CarouselMedia.fromMap(Map<String, dynamic> data) => CarouselMedia(
        ...
        sharingFrictionInfo: data['sharing_friction_info'] == null
            ? null
            : SharingFrictionInfo.fromMap(
                data['sharing_friction_info'] as Map<String, dynamic>),
        commentInformTreatment: data['comment_inform_treatment'] == null
            ? null
            : CommentInformTreatment.fromMap(
                data['comment_inform_treatment'] as Map<String, dynamic>),
      );
